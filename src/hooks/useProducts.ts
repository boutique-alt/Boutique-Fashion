  ...
  const fetchProducts = useCallback(
    async (pageIndex: number, isLoadMore = false) => {
      ...
      try {
        ...
        let query = client.from('products').select('id, slug, name, price, original_price, image, additional_images, category_slug, category_label, category_path, sizes, short_description, description, is_new, is_best_seller, on_sale, shop_category_selections, stock_quantity, sku, created_at, updated_at')
